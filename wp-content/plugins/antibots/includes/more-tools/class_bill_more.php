<?php // namespace antibots_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "antibots_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class antibots_Bill_Minozzi_Add_Ajax_Url
{
...
$antibots_bill_minozzi_add_ajax_url = new antibots_Bill_Minozzi_Add_Ajax_Url();
class antibots_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\antibots_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\antibots_BillMore\bill_install_plugin2');
    }
    ...
    public function bill_show_plugins()
    {
        ...
        $plugins_to_install[1]["image"] =
            "https://ps.w.org/antibots/assets/icon-256x256.gif?rev=2524815";
        $plugins_to_install[1]["slug"] = "antibots";
...
$show_more_plugins = new antibots_Bill_show_more_plugins();
// } // end namespace
class antibots_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \antibots_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new antibots_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class antibots_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new antibots_bill_install_QuietSkin();
