	...
	public function register_page()
	{
		...
		switch ($this->page->type) {
			...
			case 'submenu':
				...
				$page_title = !empty($this->page->title) ? $this->page->title : 'Settings Anti Bots';
				add_submenu_page(
...
{
	protected $tabs;
	protected $antibot_tabs; // LINHA ADICIONADA PARA CORRIGIR O ERRO

	public function __construct($page, $options_settings = array(), $scripts = array(), $styles = array())
	{
		parent::__construct($page, $scripts, $styles);
		$this->tabs = array();
		$this->antibot_tabs = array(); // LINHA ADICIONADA PARA CORRIGIR O ERRO
		$counter = 0;
